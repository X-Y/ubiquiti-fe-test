...
export const Multiple = () => {
  ...
  return (
    <>
      {helloValue.join(",")}
      <Checkbox name="hello" value="world" onChange={onChange("world")}>
        world
      </Checkbox>
      <Checkbox name="hello" value="xun" onChange={onChange("xun")}>
        xun
      </Checkbox>
      <Checkbox name="hello" value="yang" onChange={onChange("yang")}>
        yang
      </Checkbox>
    </>
  );
