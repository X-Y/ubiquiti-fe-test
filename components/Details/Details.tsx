  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[18rem,1fr] gap-8 max-w-[768px] mx-auto">
      <div className="bg-neutral-01 aspect-square flex place-content-center">
        <Image alt={title} iconId={icon.id} sizeX={width} sizeY={height } width={width} height={height}
      ...
      <div className="">
        ...
        <a className='text-sm text-blue-06 font-light' href=''>See all details in JSON</a>
      </div>
    </div>
  );
};
